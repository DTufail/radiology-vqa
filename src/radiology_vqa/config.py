...
class Settings(BaseSettings):
    ...
    index_dir: Path = Path("./data/indices_v3")
    chunk_size: int = 512
    ...
    retrieval_method: str = "hybrid"  # Phase 8A default: "hybrid" (BM25 + dense + RRF)
    bm25_index_dir: Path = Path("data/bm25_index_v3")
    ...
    vlm_adapter_path: str = "checkpoints/llava-med-qlora/best"  # Path to LoRA adapter dir; empty = zero-shot (no adapter)
    ...
    calibration_model_path: str = "data/calibration/mixed/isotonic_scaler.json"   # path to saved calibrator JSON
